...
The bot starts automatically via the **Kingred Bot** workflow (`node index.js`).
...
|---|---|---|
| `SESSION_ID` | Yes (or pair) | Encoded session string starting with `KINGRED~` |
...
kingred/          — Database models and message storage
